          ...
          <ListItem
            ...
            secondaryAction={
              <div>
                ...
                <IconButton size="small" onClick={() => onRemove(todo)}>
                  <DeleteOutlineOutlinedIcon fontSize="small" />
                </IconButton>
              </div>
            }
          >
            <ListItemButton sx={{ mr: "30px"}} onClick={() => onToggleCompletion(todo)}>
              <Checkbox edge="start" checked={todo.complete} disableRipple />
              <ListItemText sx={{ wordBreak: "break-all" }}  primary={todo.title} />
            </ListItemButton>
          </ListItem>
        ))}
      </List>
